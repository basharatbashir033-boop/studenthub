const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-iH1IhSCi.js","assets/index-BVxYM8sg.js","assets/index-BpKDXyjc.css"])))=>i.map(i=>d[i]);
import { r as reactExports, O as reactDomExports, j as jsxRuntimeExports, w as Primitive, t as useComposedRefs, y as createContextScope, M as useCallbackRef, Q as useLayoutEffect2, v as useControllableState, K as useId, x as composeEventHandlers, T as Portal$1, U as hideOthers, V as useFocusGuards, W as ReactRemoveScroll, Y as FocusScope, Z as DismissableLayer, $ as createSlot, k as cn, d as useNavigate, L as Layout, B as Button, a0 as ArrowLeft, F as FileText, J as Separator, o as ue, _ as __vitePreload } from "./index-BVxYM8sg.js";
import { B as Badge } from "./badge-Bx2AKasy.js";
import { L as Label, I as Input } from "./label-DQ3ueyNU.js";
import { u as useDirection, c as createCollection } from "./index-45F5foc1.js";
import { a as useSize, u as usePrevious } from "./index-B0h5bVdt.js";
import { a as ChevronDown, C as ChevronUp } from "./chevron-up-DXMqfMza.js";
import { C as Check } from "./check-4jFQp4Hc.js";
import { L as LoaderCircle } from "./loader-circle-BgCL7r0A.js";
import { D as Download } from "./download-YGhFhzii.js";
import { R as RotateCcw } from "./rotate-ccw-CpLz-S0v.js";
...
async function generatePdf(title, content, fontSize, pageSize) {
  const { jsPDF } = await __vitePreload(async () => {
    const { jsPDF: jsPDF2 } = await import("./jspdf.es.min-iH1IhSCi.js").then((n) => n.j);
    return { jsPDF: jsPDF2 };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 animate-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: "Type or paste text — export as a real PDF file" })
        ] })
      ] }),
      ...
      "div",
      {
        ...
        children: [
          ...
          !text.trim() && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Convert & Download PDF" }),
            " to get a real PDF file."
          ] })
        ]
      }
    ),
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "text-xs text-muted-foreground space-y-1 list-decimal list-inside", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "No print dialog, no popups — a real PDF file saved to your device." })
          ] })
        ]
      }
    )
