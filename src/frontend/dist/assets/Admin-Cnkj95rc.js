import { c as createLucideIcon, r as reactExports, t as useComposedRefs, v as useControllableState, j as jsxRuntimeExports, w as Primitive, x as composeEventHandlers, y as createContextScope, k as cn, z as commonjsGlobal, A as getDefaultExportFromCjs, D as clsx, R as React, E as invariant, L as Layout, e as useActor, B as Button, H as LogOut, I as Settings, J as Separator, i as Skeleton, o as ue, X, l as createActor } from "./index-BVxYM8sg.js";
import { B as Badge } from "./badge-Bx2AKasy.js";
import { L as Label$1, I as Input } from "./label-DQ3ueyNU.js";
import { u as usePrevious, a as useSize } from "./index-B0h5bVdt.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DkUBR1KJ.js";
import { C as CircleAlert } from "./circle-alert-C1_dLfSJ.js";
import { T as TrendingUp } from "./trending-up-BClaert3.js";
import { C as ChevronUp, a as ChevronDown } from "./chevron-up-DXMqfMza.js";
import { T as Trash2 } from "./trash-2-b0dqYwHX.js";
import { C as Check } from "./check-4jFQp4Hc.js";
import "./index-45F5foc1.js";
/**
  ...
  reactExports.useEffect(() => {
    try {
      ...
      if (raw) {
        ...
        if (session.isAdmin && age < 8 * 60 * 60 * 1e3) {
          setIsAdmin(true);
        } else {
...
function LoginForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col flex-1 items-center justify-center px-4 py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm rounded-2xl border border-border bg-card p-8 shadow-elevated animate-slide-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-7 w-7 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Access the StudentHub admin panel" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "admin-email", children: "Email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "admin-email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "admin-password", children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: showPass ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4" })
            }
          )
        ] })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg bg-destructive/10 border border-destructive/20 px-3 py-2.5", children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            onClick: collapsible ? () => setOpen((v2) => !v2) : void 0,
            "aria-expanded": collapsible ? open : void 0,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base text-foreground", children: title })
              ] }),
              collapsible && (open ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "h-4 w-4 text-muted-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4 text-muted-foreground" }))
            ]
          }
        ),
        (!collapsible || open) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 pt-1 border-t border-border", children })
      ]
    }
  );
}
function StatsRow({
  ...
  var _a;
  const totalToday = ((_a = usageSummary == null ? void 0 : usageSummary.perTool) == null ? void 0 : _a.reduce((acc, t2) => acc + Number(t2.usageCount), 0)) ?? 0;
  const totalAllTime = Number((usageSummary == null ? void 0 : usageSummary.totalUsage) ?? 0);
  const items = [
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: items.map((item) => {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-5 w-5", item.color) })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-16 mb-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold font-display text-foreground leading-none", children: item.value }),
...
function UsageChart({
  ...
  const chartData = ((usageSummary == null ? void 0 : usageSummary.perTool) ?? []).map((stat) => {
    const tool = tools.find((t2) => t2.id === stat.toolId);
    return {
      name: (tool == null ? void 0 : tool.name) ?? stat.toolId,
      uses: Number(stat.usageCount)
    };
  });
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-full w-full rounded-lg" }) });
  }
  if (!chartData.length) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-48 flex flex-col items-center justify-center gap-2 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-8 w-8 opacity-40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No usage data yet" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BarChart,
    {
      data: chartData,
...
function ToolsTable({
  ...
  const handleToggle = async (toolId, current) => {
    setToggling(toolId);
    await onToggle(toolId, !current);
    setToggling(null);
  };
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 mt-4", children: [1, 2, 3].map((n2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-lg" }, n2)) });
  }
  if (!tools.length) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6 mt-2", children: "No tools found." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border mt-4", children: tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm text-foreground truncate", children: tool.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                className: cn(
                  "text-xs w-fit",
                  tool.enabled ? "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400" : "bg-muted text-muted-foreground"
                ),
                children: tool.enabled ? "Enabled" : "Disabled"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              Number(tool.usageCount).toLocaleString(),
              " uses"
            ] })
          ] })
        ] }),
...
function AnnouncementItem({
  ...
  const [editText, setEditText] = reactExports.useState(ann.text);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: cn(
        ...
        ann.active ? "border-border bg-background" : "border-border bg-muted/30"
      ),
      ...
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                className: cn(
                  "text-xs shrink-0",
                  ann.active ? "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400" : "bg-muted text-muted-foreground"
                ),
                children: ann.active ? "Active" : "Inactive"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: deleting ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-3.5 w-3.5 block rounded-full border-2 border-current border-t-transparent animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-3.5 w-3.5" })
              }
            )
          ] })
        ] }),
        editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              ref: inputRef,
              value: editText,
              onChange: (e3) => setEditText(e3.target.value),
              rows: 2,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: saving ? "Saving…" : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed", children: ann.text })
      ]
    }
  );
}
function AnnouncementsSection({
  ...
  reactExports.useEffect(() => {
    if (!actor) return;
    actor.adminListAnnouncements().then((list) => {
  ...
  const handleUpdate = async (id, text, active) => {
    if (!actor) return;
    try {
      await actor.adminUpdateAnnouncement(id, text, active);
      setAnnouncements(
        (prev) => prev.map((a2) => a2.id === id ? { ...a2, text, active } : a2)
      );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 mt-4", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              value: newText,
              onChange: (e3) => setNewText(e3.target.value),
              className: "flex-1",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: adding ? "Adding…" : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: [1, 2].map((n2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full rounded-lg" }, n2)) }) : announcements.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 py-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-8 w-8 text-muted-foreground opacity-40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No announcements yet." })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: announcements.map((ann) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      AnnouncementItem,
      {
        ann,
...
function AdControlsSection({
  ...
  reactExports.useEffect(() => {
    if (!actor) return;
    actor.getAdSettings().then((s2) => {
      setSettings(s2);
      setLoading(false);
    }).catch(() => setLoading(false));
  }, [actor]);
  const toggleAd = async (slot, current) => {
    if (!actor) return;
    setToggling(slot);
    try {
      const next = !current;
      ...
      ue.success("Ad setting updated");
    } catch {
      ue.error("Failed to update ad setting");
    } finally {
      setToggling(null);
    }
  };
  const adSlots = [
    {
      ...
      enabled: (settings == null ? void 0 : settings.headerAdEnabled) ?? false
    },
    {
      key: "sidebar",
      label: "Sidebar Ad",
      description: "300×250 rectangle shown in sidebar on desktop",
      enabled: (settings == null ? void 0 : settings.sidebarAdEnabled) ?? false
    },
    {
      key: "betweenCards",
      label: "Between-Cards Ad",
      description: "320×50 inline ad shown between tool cards",
      enabled: (settings == null ? void 0 : settings.betweenCardsAdEnabled) ?? false
    }
  ];
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4 mt-4", children: [1, 2, 3].map((n2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-lg" }, n2)) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col divide-y divide-border mt-4", children: adSlots.map((slot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: slot.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: slot.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
          {
...
function ChangePasswordSection({
  ...
  const handleSubmit = async (e3) => {
    ...
    try {
      ...
      ue.error("Failed to change password");
    } finally {
      setSaving(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-4 mt-4 max-w-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "current-password", children: "Current Password" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            onClick: () => setShowCurrent((v2) => !v2),
            className: "absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors",
            "aria-label": showCurrent ? "Hide" : "Show",
            children: showCurrent ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4" })
          }
        )
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...
            value: next,
            onChange: (e3) => setNext(e3.target.value),
            required: true,
            className: "pr-10",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            type: "button",
            onClick: () => setShowNext((v2) => !v2),
            className: "absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors",
            "aria-label": showNext ? "Hide" : "Show",
            children: showNext ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "h-4 w-4" })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "confirm-password", children: "Confirm New Password" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "confirm-password",
          ...
          value: confirm,
          onChange: (e3) => setConfirm(e3.target.value),
          required: true,
          className: cn(
      ...
      mismatch && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: "Passwords do not match" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
...
function AdminDashboard({ onLogout }) {
  ...
  const [visitorStats, setVisitorStats] = reactExports.useState(null);
  ...
  const [toolsLoading, setToolsLoading] = reactExports.useState(true);
  reactExports.useEffect(() => {
    if (!actor || isFetching) return;
    Promise.all([actor.adminGetVisitorStats(), actor.adminGetUsageStats()]).then(([vs, us]) => {
      setVisitorStats(vs);
      setUsageSummary(us);
  ...
  reactExports.useEffect(() => {
    if (!actor || isFetching) return;
    actor.adminGetAllTools().then((list) => {
      setTools(list);
  ...
  const handleToggleTool = async (toolId, enabled) => {
    ...
    try {
      ...
      setTools(
        (prev) => prev.map((t2) => t2.id === toolId ? { ...t2, enabled } : t2)
      );
      ue.success(`Tool ${enabled ? "enabled" : "disabled"}`);
    } catch {
      ue.error("Failed to update tool");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 px-4 md:px-6 py-6 w-full max-w-4xl mx-auto gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-5 w-5 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl md:text-2xl font-bold text-foreground leading-tight", children: "Admin Panel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Manage StudentHub settings" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", "data-ocid": "admin-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full sm:w-auto overflow-x-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "overview", "data-ocid": "admin-tab-overview", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-3.5 w-3.5 mr-1.5" }),
          "Overview"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "tools", "data-ocid": "admin-tab-tools", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { className: "h-3.5 w-3.5 mr-1.5" }),
              "Announcements"
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "overview", className: "mt-5 flex flex-col gap-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Tool Usage Chart", icon: ChartNoAxesColumn, id: "section-chart", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        UsageChart,
        {
          usageSummary,
          tools,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "tools", className: "mt-5 flex flex-col gap-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Manage Tools", icon: Settings, id: "section-tools", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToolsTable,
        {
          tools,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "announcements", className: "mt-5 flex flex-col gap-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Section,
        {
          title: "Announcements",
          icon: Megaphone,
          id: "section-announcements",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnnouncementsSection, { actor })
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Section,
      {
        ...
        defaultOpen: true,
        id: "section-ads",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdControlsSection, { actor })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Section,
      {
        ...
        defaultOpen: false,
        id: "section-password",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChangePasswordSection, { actor })
      }
    ),
...
function AdminPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { hideSidebar: true, children: isAdmin ? /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDashboard, { onLogout: logout }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LoginForm, { onLogin: login }) });
}
export {
  AdminPage
};
