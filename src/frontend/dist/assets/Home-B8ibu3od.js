...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop, b as shouldThrowError, c as createLucideIcon, d as useNavigate, j as jsxRuntimeExports, L as Layout, G as GraduationCap, B as Button, e as Skeleton, F as FileText, P as Percent, C as Calculator, f as cn } from "./index-aYQ7uVDH.js";
import { B as Badge } from "./badge-C0AVyG_R.js";
import { u as useActor, a as useQuery, c as createActor } from "./backend-aWsbMpgi.js";
import { A as AdBanner } from "./AdBanner-CAAPMq4e.js";
import { D as Download } from "./download-DbmsV1XP.js";
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 px-4 md:px-6 py-6 max-w-4xl w-full mx-auto gap-6", children: [
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-md text-sm md:text-base leading-relaxed", children: "Fast, free tools for students — GPA calculator, percentage calculator, and PDF utilities. No sign-up required." })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-label": "Available Tools", children: [
      ...
      showSkeleton ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCardSkeleton, {}, `sk-${n}`)) }) : toolList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(0, 3).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ToolCard,
          {
            tool,
        ...
        toolList.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AdBanner, { slot: "between-cards" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(3, 6).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToolCard,
            {
              tool,
              onOpen: handleOpenTool,
        ...
        toolList.length > 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AdBanner, { slot: "between-cards" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(6).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToolCard,
            {
              tool,
              onOpen: handleOpenTool,
