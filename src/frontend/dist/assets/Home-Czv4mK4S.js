...
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, r as reactExports, a as noop, b as shouldThrowError, c as createLucideIcon, d as useNavigate, j as jsxRuntimeExports, L as Layout, G as GraduationCap, B as Button, e as Skeleton, F as FileText, P as Percent, C as Calculator, f as cn } from "./index-Djw4MOVq.js";
import { B as Badge } from "./badge-BX8uhptP.js";
import { u as useActor, a as useQuery, c as createActor } from "./backend-CU2Xnfou.js";
import { A as AdBanner } from "./AdBanner-VJr6oczF.js";
import { D as Download } from "./download-B6QZvcS1.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 px-4 md:px-6 py-6 max-w-4xl w-full mx-auto gap-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-label": "Available Tools", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
        ...
        !showSkeleton && toolList.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-xs", children: [
          toolList.length,
          " tool",
          toolList.length !== 1 ? "s" : ""
        ] })
      ...
      showSkeleton ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCardSkeleton, {}, `sk-${n}`)) }) : toolList.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(0, 2).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ToolCard,
          {
            tool,
        ...
        toolList.length > 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AdBanner, { slot: "between-cards" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(2, 4).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToolCard,
            {
              tool,
              onOpen: handleOpenTool,
        ...
        toolList.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AdBanner, { slot: "between-cards" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: toolList.slice(4).map((tool, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToolCard,
            {
              tool,
              onOpen: handleOpenTool,
